...
ids = [18, 19, 24, 30]
row = [[], [], [], []]
row[0] = [plt.imread(f'Data_{id:06d}_Proj_y_density.png') for id in ids]
row[1] = [plt.imread(f'Data_{id:06d}_Proj_y_density_grid.png') for id in ids]
row[2] = [plt.imread(f'Data_{id:06d}_000002_Slice_x_density.png') for id in ids]
row[3] = [plt.imread(f'Data_{id:06d}_000002_Slice_x_phase_wrapped.png') for id in ids]
...
plt.savefig("filament.pdf", bbox_inches='tight')
plt.close()
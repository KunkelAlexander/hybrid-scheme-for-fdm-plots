...
zooms = [1, 5, 20, 100]
row = [[], [], [], []]
row[0] = [plt.imread(f'data/figure_17/Data_000045_Lv_10_Slice_z_density_x{zoom}.png') for zoom in zooms]
row[1] = [plt.imread(f'data/figure_17/Data_000045_Lv_10_Slice_z_density_wave_grid_x{zoom}.png') for zoom in zooms]
row[2] = [plt.imread(f'data/figure_17/Data_000045_Lv_10_Slice_z_Phase_x{zoom}.png') for zoom in zooms]
row[3] = [plt.imread(f'data/figure_17/Data_000045_Lv_10_Slice_z_Phase_wave_grid_x{zoom}.png') for zoom in zooms]
...
plt.savefig("figures/figure_17.pdf", bbox_inches='tight')
plt.close()

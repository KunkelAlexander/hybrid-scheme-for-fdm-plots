...
image1 = plt.imread('data/figure_1/proj_madelung.png')
image2 = plt.imread('data/figure_1/slice_madelung.png')
image3 = plt.imread('data/figure_1/proj_wave.png')
image4 = plt.imread('data/figure_1/slice_wave.png')
image5 = plt.imread('data/figure_1/zoom_slice_madelung.png')  # Image for zoom-in in second column
image6 = plt.imread('data/figure_1/zoom_slice_wave.png')  # Image for zoom-in in second column
